			...
			<?php 
				...
				//4. 判断是否获取到了要修改的信息
					if($result4 && mysql_num_rows($result4)>0){
						$jnyo_advertiser_individual = mysql_fetch_assoc($result4);
					}else{
						die("没有找到要修改的信息！");
					}
			?>
				...
				<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body">
                    	<form class="mws-form" id="mws-validate" action="action.php?action=updateindividual" method="post">
						<input type="hidden" name="jid" value="<?php echo $jnyo_advertiser_individual['jid']; ?>"/>

                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label>真实姓名:</label>
                    				<div class="mws-form-item small">
                    					<input type="text" class="mws-textinput required" name="realname" value="<?php echo $jnyo_advertiser_individual['realname']; ?>" >
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label>身份证号:</label>
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="idnum" value="<?php echo $jnyo_advertiser_individual['idnum']; ?>" >
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label>邮箱:</label>
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="email" value="<?php echo $jnyo_advertiser_individual['email']; ?>" >
                    				</div>
                    			</div>								
								...
								<div class="mws-form-row">
                    				<label>支付宝:</label>
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="alipay" value="<?php echo $jnyo_advertiser_individual['alipay']; 
						...
						mysql_close($link);
							...
							echo $jnyo_advertiser_individual['jid'];
							?>">完善基本信息</a>
							</div>
                    		<div class="mws-button-row">
