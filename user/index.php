    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
			...
			<?php require("report.php");?>
				  ...
				  输入名称查询用户: <input type="text" name="name" />
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
								...
								<?php
					//1.导入配置文件
						$sql1 = "select * from jnyo_user order by timestamp desc";
					...
					//4. 解析结果集,并遍历输出
						while($row = mysql_fetch_assoc($result1)){
							...
							echo "<td>
								<a href='javascript:dodel({$row['jid']})'>删除</a>
								<a href='edit.php?id={$row['jid']}'>修改</a></td>";
							echo "</tr>";
