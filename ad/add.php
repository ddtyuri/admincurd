                    	...
                    	<form class="mws-form" id="mws-validate" action="action.php?action=add" method="post">
                    		<div class="mws-form-inline">
                    			...
                    			<div class="mws-form-row">
                    				<label>商家id:</label>
                    				<div class="mws-form-item small">
                    					<input type="text" class="mws-textinput required" name="bid">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label>商家名称:</label>
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="bname">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label>商品id:</label>
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="str2">	
                    				</div>
                    			</div>
