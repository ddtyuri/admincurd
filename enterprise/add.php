			 ...
			 <?php require("report.php");?>
				...
				<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-list">add user</span>
                    </div>
                    		...
                    		<div class="mws-form-inline">
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="password">
                    				</div>
                    			</div>
                            	...
                            	<div class="mws-form-row">
                                	<label>账户余额</label>
                                	<div class="mws-form-item">
                                    	<input type="text" id="s1"name="balance" class="mws-textinput" value="0" />
                                    </div>
                                </div>
								...
								<div class="mws-form-row">
                    				<label>手机号:</label>
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="mobile">
                    				</div>
                    			</div>
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item clearfix">
                    					<ul class="mws-form-list inline">
                    						<li><input type="radio" name="type" checked="checked" value="1"> <label>广告主(个人)：</label></li>
                    						<li><input type="radio" name="type" value="2" > <label>广告主（企业）：</label></li>
                    						<li><input type="radio" name="type" value="3"> <label>站长：</label></li>
