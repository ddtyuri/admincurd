...
<?php require("report.php");?>
			...
			<?php 
				...
				//3. 获取要修改信息的id号，并拼装查看sql语句，执行查询，获取要修改的信息
					$sql4 = "select * from jnyo_product where pid={$_GET['id']}";
					$result4 = mysql_query($sql4,$link);
					
				//4. 判断是否获取到了要修改的信息
					if($result4 && mysql_num_rows($result4)>0){
						$jnyo_product = mysql_fetch_assoc($result4);
					}else{
						die("没有找到要修改的信息！");
					}
			?>
				...
				<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-list">edit product</span>
                    </div>
                    <div class="mws-panel-body">
                    	<form class="mws-form" id="mws-validate" action="action.php?action=update" method="post">
						<input type="hidden" name="pid" value="<?php echo $jnyo_product['pid']; ?>"/>
						<input type="hidden" name="timestamp" value="<?php echo $jnyo_product['timestamp']; ?>"/>
                    		<div class="mws-form-inline">
                            	...
                            	<div class="mws-form-row">
                                	<label>商品价格</label>
                                	<div class="mws-form-item">
                                    	<input type="text" id="s1"name="price" class="mws-textinput" value="<?php echo $jnyo_product['price']; ?>" />
                                    </div>
                                </div>
                    			<div class="mws-form-row">
                    				<label>卖点</label>
                    				<div class="mws-form-item large">
                    					<textarea rows="100%" cols="100%" name="sellpoin" ><?php echo $jnyo_product['sellpoin']; ?></textarea>
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label>介绍</label>
                    				<div class="mws-form-item large">
                    					<textarea rows="100%" cols="100%" name="introduce"  ><?php echo $jnyo_product['introduce']; ?></textarea>
                    				</div>
                    			</div>
                    			...
                    			<div class="mws-form-row">
                    				<label>备注</label>
                    				<div class="mws-form-item large">
                    					<textarea rows="100%" cols="100%" name="remark" ><?php echo $jnyo_product['remark']; ?></textarea>
                    				</div>
                    			</div>						
								...
								<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item medium">
                    					<input type="text" class="mws-textinput required" name="url" value="<?php echo $jnyo_product['url']; ?>">
                    				</div>
                    			</div>
