			...
			<?php require("report.php");?>
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-table-1">product</span>
                    </div>
					...
					<th>备注</th><th>产品链接</th><th>发布时间</th><th>操作</th>
                            ...
                            <tbody>
								...
								<?php
					//1.导入配置文件
						$sql1 = "select * from jnyo_product order by timestamp desc";
					...
					//4. 解析结果集,并遍历输出
						while($row = mysql_fetch_assoc($result1)){
							...
							echo "<td>
								<a href='javascript:dodel({$row['pid']})'>删除</a>
								<a href='edit.php?id={$row['pid']}'>修改</a></td>";
							echo "</tr>";
						}
					//5. 释放结果集
